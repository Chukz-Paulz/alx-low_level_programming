...
/**
 * close_errchk - Closes a file descriptor and
...
/**
 * main - Copy one file to another, creating a new file with permissions 664
 *
 * @ac: Number of arguments
 * @av: List of arguments
 *
 * Return: 97 if the incorrect number of args,
 * 98 if file_from does not exist
 * or is unreadable, 99 if write fails,
 *         100 if file close fails, 0 otherwise
 */
int main(int ac, char *av[])
{
	/*declaration and buffer allocation*/
	char buf[1024];
	...
	file_to = open(av[2], O_WRONLY | O_CREAT | O_TRUNC, S_IRUSR
